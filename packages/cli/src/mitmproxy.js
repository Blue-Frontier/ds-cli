...
const server = require('@blue-frontier/mitmproxy')
const jsonApi = require('@blue-frontier/mitmproxy/src/json')
const log = require('@blue-frontier/mitmproxy/src/utils/util.log.server') // 当前脚本是在 server 的进程中执行的，所以使用 mitmproxy 中的logger
